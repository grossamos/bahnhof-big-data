...
#| label: fig-station-map-kat
#| fig-cap: Karte aller Bahnstationen nach Kategorie
...
An @top12 lassen sich folgende Erkenntnisse ableiten:
...
München, Frankfurt und Stuttgart haben im Vergleich zu den anderen Städten verhältnismäßig mehr Bahnhöfe der Kategorie 3. Dies ist auch in Figure @fig-station-map-kat sichtbar, da hier in der rechten Karte mit leicht transparenten Punkten in diesen Städten die Kategorie 3 deutlich ausgeprägter ist.
