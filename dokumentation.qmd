...
Im Allgemeinen unterscheiden sich die Häufigkeiten von Bahnhöfskategorien auf Bundesebene kaum (vorallem im vergleich zu den Städten in @fig-top12). 
...
Zusätzlich werden hier outlier herrausgefiltert. In diesem Fall sind das PLZ welche unter 30 Einwohner haben.
...
Jedoch ist das Verhältniss Einwohner pro Bahnhof in Deutschland recht gleichmäßig verteilt. 
...
Dennoch kann man feststellen das die Lücken im Osten des Landes deutlich kleiner sind und es somit in fast jeder Postleitzahl mindestens einen Bahnhof gibt. 
