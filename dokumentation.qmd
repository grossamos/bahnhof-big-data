...
todo: erklärung (alpha, ....)

todo: karten aufteilen mit text dazwischen (erklärung, fazit, ...)
...
Zunächst müssen die Daten wieder angepasst werden. Hierzu werden die Postleitzahlen nach den ersten beiden Ziffern gruppiert und die Summe aller Einwohner sowie aller Bahnhöfe in diesem Gebiet hinzugefügt. Darauf wird mit *st_area* die Fläche jedes Gebietes us den Geometriedaten berechnet, welches sehr rechenintensiv ist. Im Amschluss werden wieder drei Karten zur Befölkerungsdichte, Bahnhofsdichte und Anzahl der Bahnhöfe pro Person erstellt.
