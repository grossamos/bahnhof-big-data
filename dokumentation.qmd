...
Mit diesen drei Karten kann man die vorhergehenden Vermutungen spezifizieren. Es sind nun in der dritten Karte drei Regionen (Ost, Nordwest und Süd) zu erkennen, welche eine unterschiedliche Anzahl an Bahnhöfen pro Person haben.
...
todo: text datenqualität (entfernte entfernung der na's)
...
todo: text erkenntnisse

- alles gleichmäßig und "gerecht"
- wir sehen wesentlich breiteren ausbau im osten (mehr plz haben bahnhöfe) (mehr fläche)
